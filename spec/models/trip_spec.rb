...
describe Trip do 
  ...
  it {shoud have_field(:rating)}
  it {should have_field(:datetime)}
  ...
  it {should have_field(:active).of_type(Datetime)}
  ...
  it {should have_index_for(title: 1)}
  ...
  it {should validate_numericality_of(:rating).only_integer: true}
